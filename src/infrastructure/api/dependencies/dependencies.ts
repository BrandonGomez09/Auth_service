...
const updateUserAvailabilityUseCase = new UpdateUserAvailabilityUseCase(
  userAvailabilityRepository,
  userRepository
);
...
export const registerKitchenAdminController =
  new RegisterKitchenAdminController(registerKitchenAdminUseCase);
...
export const resendEmailVerificationController =
  new ResendEmailVerificationController(resendEmailVerificationUseCase);

export const verifyPhoneController = new VerifyPhoneController(
  verifyPhoneUseCase
);

export const resendPhoneVerificationController =
  new ResendPhoneVerificationController(resendPhoneVerificationUseCase);

export const requestPasswordResetController =
  new RequestPasswordResetController(requestPasswordResetUseCase);
...
export const removeRoleController = new RemoveRoleController(
  removeRoleUseCase
);

export const getUserPermissionsController = new GetUserPermissionsController(
  getUserPermissionsUseCase
);
...
export const checkUserPermissionController =
  new CheckUserPermissionController(checkUserPermissionUseCase);

export const getUserByIdController = new GetUserByIdController(
  new GetUserByIdUseCase(userRepository)
);

export const getUsersPaginatedController = new GetUsersPaginatedController(
  new GetUsersPaginatedUseCase(userRepository)
);
...
export const getUserSkillsController = new GetUserSkillsController(
  getUserSkillsUseCase
);

export const addUserSkillController = new AddUserSkillController(
  addUserSkillUseCase
);

export const removeUserSkillController = new RemoveUserSkillController(
  removeUserSkillUseCase
);

export const setUserAvailabilityController = new SetUserAvailabilityController(
  setUserAvailabilityUseCase
);

export const updateUserAvailabilityController =
  new UpdateUserAvailabilityController(updateUserAvailabilityUseCase);

export const deleteUserAvailabilityController =
  new DeleteUserAvailabilityController(userAvailabilityRepository);

export const getUserAvailabilityController =
  new GetUserAvailabilityController(getUserAvailabilityUseCase);

export const checkUserAvailabilityController =
  new CheckUserAvailabilityController(checkUserAvailabilityUseCase);

export const createUserScheduleController = new CreateUserScheduleController(
  createUserScheduleUseCase
);

export const updateUserScheduleController = new UpdateUserScheduleController(
  updateUserScheduleUseCase
);

export const deleteUserScheduleController = new DeleteUserScheduleController(
  deleteUserScheduleUseCase
);
...
export const updateUserReputationController =
  new UpdateUserReputationController(updateUserReputationUseCase);

export const getUserReputationHistoryController =
  new GetUserReputationHistoryController(getUserReputationHistoryUseCase);

export const completeProfileController = new CompleteProfileController(
  completeProfileUseCase
);

export const getMyProfileController = new GetMyProfileController(
  getMyProfileUseCase
);
